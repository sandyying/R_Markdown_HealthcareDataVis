...
tabItem(tabName = "bar",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__1_", "Title 1", "Covered Charges Per Capita By State"),
             numericInput("titleFont__1_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__1_", "Legend Title", "States"),
          ...
          tabPanel("Axis Labels",
             textInput("xLabel__1_", "x-Axis Label", "States"),
             textInput("yLabel__1_", "y-Axis Label 1", "Covered Charges Per Capita"),
